...
<body>
    ...
    <header class="bg-white shadow-md p-5 flex justify-between">
        ...
        <div class="flex-1 p-6 overflow-auto">
            ...
            <form class="w-[380px]  mt-[20px]" action="{{ route('admin.store') }}" method="POST">
                ...
                <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded w-[160px]">Add Admin</button>
            </form>
        </div>
